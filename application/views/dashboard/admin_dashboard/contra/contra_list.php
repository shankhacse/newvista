...
vertical-align: inherit;
   ...
   <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Contra List</li>
      </ol>
    </section>
    ...
    <section class="content">
            ...
            <div class="box-body">
              ...
              <table id="contralist" class="table table-bordered table-striped dataTables" style="border-collapse: collapse !important;">
                <thead>
                <tr>
                ...
                <tbody>
              	...
              	<?php 
				          // print_r($bodycontent['ContraList']);
              		$i = 1;
              		foreach ($bodycontent['ContraList'] as $value) { 
